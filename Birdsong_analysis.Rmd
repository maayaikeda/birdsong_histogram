...
As expected, motif duration is the most important variable other than start time. Start time can be ignored because the predicted directed and indirect recordings were done on a different day. 
