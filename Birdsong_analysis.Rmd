...
1. For bird #1 (G544), the songs that are sang while the mate is calling is overall shorter in duration than his undirected song. 
2. For bird #2 (O375), while we don't have recordings from him while he was a lone, the songs whithout the contamination of female calls were longer in duration than the songs sang while his mate was calling. 
